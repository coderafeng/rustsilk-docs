...
packages:
  ...
  vitepress-plugin-auto-sidebar@1.4.0:
    resolution: {integrity: sha512-fxVo4WUc9QiBt9XiveBEUi38qZ9TBOj2fFUCRZJIlp+FVmQVYh0bOxE802b1UGouQGe8XutkXl0z0Vbm/++fQg==}
    engines: {node: '>=18'}
...
snapshots:
  ...
  '@vitejs/plugin-vue@6.0.7(vite@7.3.5)(vue@3.5.38)':
    dependencies:
      '@rolldown/pluginutils': 1.0.1
      vite: 7.3.5
      vue: 3.5.38
  ...
  '@vueuse/integrations@14.3.0(focus-trap@8.2.1)(vue@3.5.38)':
    dependencies:
      '@vueuse/core': 14.3.0(vue@3.5.38)
      '@vueuse/shared': 14.3.0(vue@3.5.38)
      vue: 3.5.38
