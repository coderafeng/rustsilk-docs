...
**IS NULL** 和 **IS NOT NULL** 可以用在 **[SELECT](./000.SELECT.md#概述)** 语句或者 **[WHERE](./005.WHERE%20条件.md#概述)** 子句中。
...
在 **[staff](../01.PostgreSQL%20起步/04.PostgreSQL%20示例数据库.md#员工表)** 表中， **picture** 中存储了职员的照片文件， 要从 **staff** 表中查询那些没有上传图片的职员， 需要检查 **picture** 是否为 **NULL**, 请使用以下带有 **IS NULL** 的 SQL 语句：
