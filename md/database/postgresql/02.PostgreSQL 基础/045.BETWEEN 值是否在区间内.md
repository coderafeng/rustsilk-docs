...
通常情况下，您在 **[WHERE](./005.WHERE%20条件.md#概述)** 子句中使用 **BETWEEN** 运算符， 如下所示：
...
当然，出了 **[INSERT](./130.INSERT%20插入新行.md#概述)** 语句外， **[WHERE](./005.WHERE%20条件.md#概述)** 子句同样可以用于 **[UPDATE](./140.UPDATE%20更新行.md#概述)** 或者 **[DELETE](./150.DELETE%20删除行.md#概述)** 语句。
...
要从 **[film](../01.PostgreSQL%20起步/04.PostgreSQL%20示例数据库.md#影片表)** 表中检索影片时长在在 95 到 98 分钟之间的影片，请使用以下语句：
...
要从 **[payment](../01.PostgreSQL%20起步/04.PostgreSQL%20示例数据库.md#支付表)** 表中检索金额在 5 到 5.98 之间的付款，请使用以下语句：
