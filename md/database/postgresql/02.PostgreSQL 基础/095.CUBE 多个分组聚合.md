...
在 PostgreSQL 中， **CUBE** 是 **[GROUP BY](./075.GROUP%20BY%20分组.md#概述)** 子句的参数，允许您在一次查询中生成多个维度的报表。和 **[ROLLUP](./090.ROLLUP%20多个分组聚合.md#概述)** 一样， 在某些特定的场景下， **CUBE** 可以简化 **[GROUPING SETS](./085.GROUPING%20SETS%20多个分组聚合.md#概述)**。
