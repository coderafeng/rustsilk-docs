...
您可以在 **[SELECT](./000.SELECT.md#概述)** 语句以及 **[WHERE](./005.WHERE%20条件.md#概述)**, **[GROUP BY](075.GROUP%20BY%20分组.md#概述)**, 和 **[HAVING](./080.HAVING%20分组的过滤条件.md#概述)** 子句中使用 **CASE** 表达式。
...
在以下实例中，我们使用 Sakila 示例数据库中的 **[film](../01.PostgreSQL%20起步/04.PostgreSQL%20示例数据库.md#影片表)** 表作为演示。
