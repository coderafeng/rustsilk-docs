...
**FETCH** 子句与 **[LIMIT](./020.LIMIT%20限制返回的行数.md#概述)** 子句作用相同，但是 **FETCH** 子句是 SQL 标准，而 **LIMIT** 子句不是 SQL 标准。
...
要限制从 **[film](../01.PostgreSQL%20起步/04.PostgreSQL%20示例数据库.md#影片表)** 表查询时最多返回 5 行，请使用下面的带有 **FETCH** 子句的 **SELECT** 语句：
