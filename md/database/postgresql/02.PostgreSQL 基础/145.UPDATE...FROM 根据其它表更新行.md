...
在 PostgreSQL，您可以使用**[子查询](./105.子查询.md#概述)**做到一点，也可以更加方便地使用 **UPDATE...FROM** 语句完成它。
...
- 和普通的 **[UPDATE](./140.UPDATE%20更新行.md#概述)** 语句相比，此语句多了 **FROM** 子句，并且 **[WHERE](./005.WHERE%20条件.md#概述)** 子句是必须的。
...
- **[city](../01.PostgreSQL%20起步/04.PostgreSQL%20示例数据库.md#城市表)** 表中存储了城市的信息。
- **[country](../01.PostgreSQL%20起步/04.PostgreSQL%20示例数据库.md#国家表)** 表中存储了国家的信息。
